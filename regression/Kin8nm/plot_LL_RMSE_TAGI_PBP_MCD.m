...
filename6 = 'UCI_TAGI_JMLRkin8nmLLtest400Epoch.txt';
filename7 = 'UCI_kin8nmLLtest_2L100nodes.txt';
...
filename6 = 'UCI_TAGI_JMLRkin8nmRMSEtest400Epoch.txt';
filename7 = 'UCI_kin8nmRMSEtest_2L100nodes.txt';
TAGI_2L   = importdata(filename7);
TAGI_JMLR = importdata(filename6);
TAGI_LL   = importdata(filename1);
PBP_LL    = importdata(filename2);
