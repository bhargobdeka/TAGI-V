...
filename6 = 'UCI_TAGI_JMLR_powerPlantLLtest400Epoch.txt';
filename7 = 'UCI_powerPlantLLtest_2L100nodes.txt';
...
filename6 = 'UCI_TAGI_JMLR_powerPlantRMSEtest400Epoch.txt';
filename7 = 'UCI_powerPlantRMSEtest_2L100nodes.txt';
TAGI_2L   = importdata(filename7);
TAGI_JMLR = importdata(filename6);
TAGI_LL   = importdata(filename1);
PBP_LL    = importdata(filename2);
