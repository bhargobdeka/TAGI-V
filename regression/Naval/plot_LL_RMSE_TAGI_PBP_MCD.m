...
filename6 = 'UCI_TAGI_JMLRnavalLLtest400Epoch.txt';
filename7 = 'UCI_navalLLtest_2L100nodes.txt';
...
filename6 = 'UCI_TAGI_JMLRnavalRMSEtest400Epoch.txt';
filename7 = 'UCI_navalRMSEtest_2L100nodes.txt';
TAGI_2L   = importdata(filename7);
TAGI_JMLR = importdata(filename6);
TAGI_LL   = importdata(filename1);
PBP_LL    = importdata(filename2);
