...
filename6 = 'UCI_TAGI_JMLRConcreteLLtest400Epoch.txt';
filename7 = 'UCI_concreteLLtest_2L100nodes.txt';
...
title('Test Log-Likelihood Conc')
drawnow
...
filename6 = 'UCI_TAGI_JMLRConcreteRMSEtest400Epoch.txt';
filename7 = 'UCI_concreteRMSEtest_2L100nodes.txt';
TAGI_2L   = importdata(filename7);
TAGI_JMLR = importdata(filename6);
TAGI_LL   = importdata(filename1);
PBP_LL    = importdata(filename2);
