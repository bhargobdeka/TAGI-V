...
if net.gs_Gain == 1
    net.gainS          = ones(1,length(net.layer)-1);
    net.gainS_v2hat    = 1;
    net.gainSb_v2hat   = 1;
    net.gainM_v2hat    = 1;
else
...
[Gain_factor, run_time, patience]  = opt.GridsearchV2(net,x,y, []);
Gains                              = Gain_factor;
...
fileID = fopen('GS_keggundirected.txt','w');
