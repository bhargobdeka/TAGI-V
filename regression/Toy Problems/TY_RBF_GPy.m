...
if net.gs_Gain == 1
    ...
    net.gainSb_v2hat   = 1;
    net.gainM_v2hat    = 1;
    net.m_w_v2hat      = [1e-07*(1/net.nx)        1e-07*(1/50)       0.01^2*Gains(2)*(1/50)];
    net.m_b_v2hat      = [0.05*(1/net.nx)         0.05*(1/50)       0.01^2*(1/50)];
    
    net.var_w_v2hat    = [(1e-07*(1/net.nx))^2    (1e-07*(1/50))^2   0.01^4*Gains(2)*(1/50)];
    net.var_b_v2hat    = [(0.05*(1/net.nx))^2     (0.05*(1/50))^2   0.01^4*(1/50)];
end
